...
const OVERLAYS: OverlayDef[] = [
  ...
  { id: "lifted_index",          label: "Lifted Index",            unit: "",     unitType: "none",     group: "Thermal / Lift",  variable: "lifted_index",             legendMinVal: -8,  legendMaxVal: 4,    gradient: steppedGradient(["#ef4444","#f97316","#eab308","#22c55e","#3b82f6"]), colors: ["#ef4444","#f97316","#22c55e","#3b82f6"], excludeModels: ["nbm"] },
