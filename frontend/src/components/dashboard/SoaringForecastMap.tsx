...
const OVERLAYS: OverlayDef[] = [
  { id: "thermal_strength",      label: "Thermal Strength",        unit: "m/s",  unitType: "vario",    group: "Thermal / Lift",  variable: "vertical_velocity_700hPa", legendMinVal: 0,   legendMaxVal: 1.5,  gradient: "linear-gradient(to right,rgb(180,230,235),rgb(150,220,200),rgb(110,200,130),rgb(170,215,70),rgb(210,225,45),rgb(235,175,25),rgb(220,45,20))", colors: ["#b4e6eb","#6ec882","#d2e12d","#dc2d14"], excludeModels: ["nbm"] },
