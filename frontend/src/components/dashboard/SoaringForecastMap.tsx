...
const OVERLAYS: OverlayDef[] = [
  { id: "thermal_strength",      label: "Thermal Strength",        unit: "m/s",  unitType: "vario",    group: "Thermal / Lift",  variable: "vertical_velocity_700hPa", legendMinVal: 0,   legendMaxVal: 7.6,  gradient: "linear-gradient(to right,rgba(180,230,235,0.2),rgb(150,220,200),rgb(110,200,130),rgb(170,215,70),rgb(210,225,45),rgb(235,175,25),rgb(220,45,20))", colors: ["#b4e6eb","#6ec882","#d2e12d","#dc2d14"], excludeModels: ["nbm"] },
  { id: "cape",                  label: "CAPE",                    unit: "J/kg", unitType: "jkg",      group: "Thermal / Lift",  variable: "cape",                     legendMinVal: 0,   legendMaxVal: 4000, gradient: "linear-gradient(to right,rgba(180,230,235,0.2),rgb(150,220,200),rgb(110,200,130),rgb(170,215,70),rgb(210,225,45),rgb(235,175,25),rgb(220,45,20))", colors: ["#b4e6eb","#6ec882","#d2e12d","#dc2d14"] },
  { id: "convective_cloud_top",  label: "Top of Lift",             unit: "m",    unitType: "altitude", group: "Thermal / Lift",  variable: "convective_cloud_top",     legendMinVal: 0,   legendMaxVal: 5500, gradient: "linear-gradient(to right,#9ca3af,#22c55e,#60a5fa,#a78bfa,#ec4899)", colors: ["#9ca3af","#22c55e","#60a5fa","#ec4899"], excludeModels: ["nbm"] },
  { id: "boundary_layer_height", label: "Boundary Layer Height",   unit: "m",    unitType: "altitude", group: "Thermal / Lift",  variable: "boundary_layer_height",    legendMinVal: 0,   legendMaxVal: 5500, gradient: "linear-gradient(to right,#9ca3af,#22c55e,#60a5fa,#a78bfa,#ec4899)", colors: ["#9ca3af","#22c55e","#60a5fa","#ec4899"], excludeModels: ["nbm"] },
