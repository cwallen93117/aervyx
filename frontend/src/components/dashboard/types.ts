...
export type MeetStatsRecord = { total_airtime_seconds: number; total_on_task_seconds: number; max_gps_altitude: MeetStatsHighlightRecord | null; lowest_save: MeetStatsHighlightRecord | null; total_xc_distance_km: number };
