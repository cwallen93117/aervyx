        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              if (ble.connectedDevice == null && ble.hasSavedBleDevice) ...[
                Card(
                  child: Padding(
                    padding: const EdgeInsets.all(16),
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            ble.savedBleAutoReconnectEnabled
                                ? 'Auto-reconnecting to ${ble.savedBleDeviceName}'
                                : 'Last paired: ${ble.savedBleDeviceName}',
                        ...
                        if (ble.reconnecting)
                          ...
                          IconButton(
                            onPressed: () =>
                                ble.restoreAutoReconnect(force: true),
                ...
                child: ble.discoveredDevices.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final isThisConnecting = ble.isConnecting &&
