"""Read-only profile matrix schema shown in the desktop provisioner."""
...
PROFILE_KEYS = ("pilot", "driver", "driver_wifi", "base_station")
PROFILE_LABELS = {
    "pilot": "Pilot",
    "driver": "Driver",
...
MATRIX_ROWS: tuple[MatrixRow, ...] = (
    MatrixRow("Device", "Role", "config.device.role"),
    MatrixRow("Device", "Rebroadcast", "config.device.rebroadcast_mode"),
    ...
    MatrixRow("Position", "GPS mode", "config.position.gps_mode"),
    ...
    MatrixRow("Position", "Position flags", "config.position.position_flags", "number"),
    MatrixRow("LoRa", "Region", "config.lora.region"),
    MatrixRow("LoRa", "Use preset", "config.lora.use_preset", "boolean"),
    MatrixRow("LoRa", "Modem preset", "config.lora.modem_preset"),
    ...
    MatrixRow("Bluetooth", "Pairing mode", "config.bluetooth.mode"),
