...
-- MQTT columns let the admin choose between local Mosquitto and a cloud VM
-- Mosquitto instance.  mesh_profiles stores the 4 profile presets
...
ALTER TABLE site_settings ADD COLUMN mqtt_broker_mode VARCHAR(20) NOT NULL DEFAULT 'local_mosquitto';
